...
var fs = flag.NewFlagSet("comments", flag.ExitOnError)
var debugAddr = fs.String("debug.addr", ":6480", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":6481", "HTTP listen address")
var grpcAddr = fs.String("grpc-addr", ":6482", "gRPC listen address")
var thriftAddr = fs.String("thrift-addr", ":6483", "Thrift listen address")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterCommentsServer(baseServer, grpcServer)
